...
import matplotlib as mpl  # Add this line to define mpl
...
# Mark a specific point with a star
specific_lat = 29.90172
specific_lon = -95.32496
ax.plot(specific_lon, specific_lat, marker='*', color='black', markersize=14, transform=ccrs.Geodetic())
# Customize gridlines
...
# Show the plot
plt.title('NEXRAD Radar Estimated Rain Rate')
plt.show()
...
specific_lat = 29.90172
specific_lon = -95.32496
ax.plot(specific_lon, specific_lat, marker='*', color='black', markersize=20, transform=ccrs.Geodetic())  # Adjust marker size as needed
